...
<div class="col">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="steam://connect/<?php echo ''.$serverip.''; ?>/">
  <img src="<?php echo ''.$servericon.''; ?>"  width=32 height=32 align=absmiddle border=0> <?php echo ''.$servername.''; ?></a>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse shadow">
      <div class="position-sticky pt-3 sidebar-sticky" style="background-color: #e3f2fd;">
        <ul class="nav flex-column">
		  ...
		  <li class="nav-item">
            <a class="nav-link" href="bestusers.php">
			  <span data-feather="users" class="align-text-bottom"></span>
              Best Players
            </a>
          </li>
		   <li class="nav-item">
            <a class="nav-link" href="vipslist.php">
            <span data-feather="file-text" class="align-text-bottom"></span>
              Vips
            </a>
          </li>
		   <li class="nav-item">
            <a class="nav-link" href="overviewranks.php">
              <span data-feather="bar-chart-2" class="align-text-bottom"></span>
              Ranks
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="playeronline.php">
              <span data-feather="bar-chart-2" class="align-text-bottom"></span>
              Players Online
            </a>
          </li>
