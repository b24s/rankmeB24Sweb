...
<?php
$authors = $connection2->query("SELECT * FROM rankme ORDER BY score DESC LIMIT 3")->fetchAll();
       ...
       $json = file_get_contents('http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=741466C2C1DB9732369BAEEACA0251A8&steamids='. getFriendId($authid) .'');
        ...
        if($author['steam'] == "BOT"){
          ...
          endforeach;	
		    ...
		    echo '<p><a href="showplayer2.php?id='.$author['id'].'">'.$author['name'].'</a><br>';
       ...
       $json = file_get_contents('http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=741466C2C1DB9732369BAEEACA0251A8&steamids='. getFriendId($authid) .'');
        ...
        if($author['steam'] == "BOT"){
          ...
          endforeach;	
		    ...
		    echo '<a href="showplayer2.php?id='.$author['id'].'">'.$author['name'].'</a><br>';
		    echo ''.$author['score'].' Points';
	    }
    endforeach;	 
      ?>
