<?php 
  ...
  $authors = $connection2->query("SELECT * FROM rankme ORDER BY score DESC LIMIT $paginationStart, $limit")->fetchAll();
  // Get total records
  $sql = $connection2->query("SELECT count(id) AS score FROM rankme")->fetchAll();
        ...
        <table class="table align-middle table-light table-hover table-bordered shadow p-3 mb-5 bg-white rounded overflow-hidden">
            ...
            <tbody>
                ...
                <tr class="align-bottom">
                    <td><h5><?php echo '<a href="showplayer2.php?id='.$author['id'].'">'.$author['name'].'</a>'; ?></h5></td>
        ...
        <nav aria-label="Page navigation example mt-5">
            <ul class="pagination pagination-sm justify-content-center">
                ...
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    <a class="page-link" href="points2.php?page=<?= $i; ?>"> <?= $i; ?> </a>
                </li>
                <?php endfor; ?>
...
function fill(Value) {
   ...
   //Hiding "display" div in "points2.php" file.
...
$(document).ready(function() {
   ...
   //On pressing a key on "Search box" in "points2.php" file. This function will be called.
   ...
   $("#search").keyup(function() {
       ...
       if (playername == "") {
           ...
           //Assigning empty value to "display" div in "points2.php" file.
       ...
       //If playername is not empty.
           ...
           $.ajax({
               ...
               //Data will be sent to "name_search2.php".

               url: "name_search2.php",

               //Data, that will be sent to "points2.php".
