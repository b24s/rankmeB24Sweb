...
<div class="container-fluid">
  ...
  <div class="col-sm-6 mb-3 mb-sm-0">
    ...
    <div class="col">
      <h5 class="card-text"><a class="nav-link" href="points.php"><?php echo $ukcounter; ?></a></h5>
    </div>
  </div>
  <div class="row row-cols-auto">
	  <div class="col">
    ...
    <div class="col">
      <h5 class="card-text"><a class="nav-link" href="vipslist.php"><?php echo $total; ?></a></h5>
    </div>
  </div>
  <div class="row row-cols-auto">
	  <div class="col">
    ...
    <div class="col">
      <?php
         echo ' <h5 class=card-text><a class=nav-link href=playeronline.php>'.$lastcounter2.'</a></h5>';   
      ?>
    </div>
  </div>
      </div>
