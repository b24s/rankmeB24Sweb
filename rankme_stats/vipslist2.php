<?php 
  ...
  $authors = $connection2->query("SELECT * FROM vip_users ORDER BY account_id DESC LIMIT $paginationStart, $limit")->fetchAll();
  // Get total records
  $sql = $connection2->query("SELECT count(account_id) AS account_id FROM vip_users")->fetchAll();
