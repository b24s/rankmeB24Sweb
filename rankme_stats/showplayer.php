...
<div class="col-md-3 mb-3">
         ...
         <li class="list-group-item d-flex justify-content-between lh-sm">
		  ...
		  <div>
            ...
            if($row['kills'] > 0 and  $row['kills'] < 50){
				...
				$me_img = "<img src=img/rank/specialist5.png  width=70 height=67 align=absmiddle border=0>";
				...
				$me_img = "<img src=img/rank/specialist6.png  width=70 height=67 align=absmiddle border=0>";
    ...
    <!-- End Example Code -->
		   ...
		   <a href="overviewranks.php">Overview ranks</a>
        </div>
      </div>
</div>
